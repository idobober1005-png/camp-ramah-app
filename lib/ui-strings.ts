...
const STRINGS: Record<string, S> = {
  ...
  'home.action.syllabus.desc':   ['המר תוכנית לפעילויות',   'Convert curriculum to activities'],
  ...
  // ── Syllabus page ─────────────────────────────────────────────
  'syllabus.title':       ['📄 המרת סילבוס',            '📄 Syllabus Converter'],
  'syllabus.subtitle':    ['העלה תוכנית לימודים → AI יחלץ מטרות → יצור פעילויות מוכנות', 'Upload curriculum → AI extracts objectives → Creates ready activities'],
  ...
  'syllabus.extract':     ['✨ חלץ מטרות מהסילבוס',      '✨ Extract Objectives'],
  'syllabus.extracting':  ['מחלץ מטרות...',             'Extracting objectives...'],
  ...
  'syllabus.done':        ['✅ נוצרו {n} פעילויות ונשמרו לבנק!', '✅ Created {n} activities and saved to bank!'],
  ...
  'syllabus.err.network': ['לא ניתן להתחבר. בדוק את החיבור לאינטרנט.', 'Cannot connect. Check your internet connection.'],
